...
EXPECTED_GRAPHS = {
    'simple_isomorphic_0': {(1, 1): {'x': 1, 'y': 1, 'h': False, 'type': 'V'},
                            ...
                            (-0.5625, 0.625): {'x': -0.5625, 'y': 0.625, 'r': False, 'type': 'Q'},
                            (-0.5625, -0.625): {'x': -0.5625, 'y': -0.625, 'r': False, 'type': 'Q'}},
    'simple_isomorphic_1': {(1, 1): {'x': 1, 'y': 1, 'h': False, 'type': 'V'},
                            (1.5, 0): {'x': 1.5, 'y': 0, 'h': False, 'type': 'V'},
                            (1, -1): {'x': 1, 'y': -1, 'h': False, 'type': 'V'},
                            (-1, -1): {'x': -1, 'y': -1, 'h': False, 'type': 'V'},
                            (-1.5, 0): {'x': -1.5, 'y': 0, 'h': False, 'type': 'V'},
                            ...
                            (-0.5625, 0.625): {'x': -0.5625, 'y': 0.625, 'r': False, 'type': 'Q'},
                            (0.5625, 0.625): {'x': 0.5625, 'y': 0.625, 'r': False, 'type': 'Q'}},
    'simple_isomorphic_2': {(1, 1): {'x': 1, 'y': 1, 'h': False, 'type': 'V'},
                            (1.5, 0): {'x': 1.5, 'y': 0, 'h': False, 'type': 'V'},
                            (1, -1): {'x': 1, 'y': -1, 'h': False, 'type': 'V'},
                            (-1, -1): {'x': -1, 'y': -1, 'h': False, 'type': 'V'},
                            (-1.5, 0): {'x': -1.5, 'y': 0, 'h': False, 'type': 'V'},
                            ...
                            (0.5625, 0.625): {'x': 0.5625, 'y': 0.625, 'r': False, 'type': 'Q'},
                            (-1.0, 0.0): {'x': -1.0, 'y': 0.0, 'r': False, 'type': 'Q'}},
    'isomorphic_with_various_edge_labels': {(1, 1): {'x': 1, 'y': 1, 'h': False, 'type': 'V'},
                                            (1.5, 0): {'x': 1.5, 'y': 0, 'h': False, 'type': 'V'},
                                            (1, -1): {'x': 1, 'y': -1, 'h': False, 'type': 'V'},
                                            (-1, -1): {'x': -1, 'y': -1, 'h': False, 'type': 'V'},
                                            (-1.5, 0): {'x': -1.5, 'y': 0, 'h': False, 'type': 'V'},
                                            ...
                                            (0.5625, 0.625): {'x': 0.5625, 'y': 0.625, 'r': False, 'type': 'Q'},
                                            (-0.5625, -0.625): {'x': -0.5625, 'y': -0.625, 'r': False, 'type': 'Q'}},
    'graph_with_subgraph_not_changed': {(1, 1): {'x': 1, 'y': 1, 'h': False, 'type': 'V'},
                                        (1.5, 0): {'x': 1.5, 'y': 0, 'h': False, 'type': 'V'},
                                        (1, -1): {'x': 1, 'y': -1, 'h': False, 'type': 'V'},
                                        (-1, -1): {'x': -1, 'y': -1, 'h': False, 'type': 'V'},
                                        (-1.5, 0): {'x': -1.5, 'y': 0, 'h': False, 'type': 'V'},
                                        (-1, 1): {'x': -1, 'y': 1, 'h': False, 'type': 'V'},
                                        (2, 1): {'x': 2, 'y': 1, 'h': False, 'type': 'V'},
                                        (2, 2): {'x': 2, 'y': 2, 'h': False, 'type': 'V'},
                                        (-2, 2): {'x': -2, 'y': 2, 'h': False, 'type': 'V'},
                                        (1.25, 0.5): {'x': 1.25, 'y': 0.5, 'b': True, 'type': 'E'},
                                        (1.25, -0.5): {'x': 1.25, 'y': -0.5, 'b': True, 'type': 'E'},
                                        (0.0, -1.0): {'x': 0.0, 'y': -1.0, 'b': True, 'type': 'E'},
                                        (-1.25, -0.5): {'x': -1.25, 'y': -0.5, 'b': True, 'type': 'E'},
                                        (-1.25, 0.5): {'x': -1.25, 'y': 0.5, 'b': True, 'type': 'E'},
                                        (0.0, 1.0): {'x': 0.0, 'y': 1.0, 'b': True, 'type': 'E'},
                                        (1.5, 1.0): {'x': 1.5, 'y': 1.0, 'b': False, 'type': 'E'},
                                        (1.5, 1.5): {'x': 1.5, 'y': 1.5, 'b': False, 'type': 'E'},
                                        (2.0, 1.5): {'x': 2.0, 'y': 1.5, 'b': False, 'type': 'E'},
                                        (-1.5, 1.5): {'x': -1.5, 'y': 1.5, 'b': False, 'type': 'E'},
                                        (0.0, 0.0): {'x': 0.0, 'y': 0.0, 'r': True, 'type': 'Q'}},
    'graph_with_subgraph_changed': {(1, 1): {'x': 1, 'y': 1, 'h': False, 'type': 'V'},
                                    (1.5, 0): {'x': 1.5, 'y': 0, 'h': False, 'type': 'V'},
                                    (1, -1): {'x': 1, 'y': -1, 'h': False, 'type': 'V'},
                                    (-1, -1): {'x': -1, 'y': -1, 'h': False, 'type': 'V'},
                                    (-1.5, 0): {'x': -1.5, 'y': 0, 'h': False, 'type': 'V'},
...
def correct_graph_P13_test():
    for i in range(3):
        ...
        is_changed = apply_test(left_side, True, P13)
...
def remove_edge_P13_test():
    ...
    success = not apply_test(left_side, True, P13)
...
def correct_graph_with_subgraph_with_hanging_nodes_P13_test():
    left_side = create_graph_6_with_subgraph()
    left_side = add_hanging_nodes_to_graph_for_test(left_side, 10, 9, [0, 3])
